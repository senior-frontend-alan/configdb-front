...
// Используем функцию clearError из хранилища
const clearError = () => {
...
<template>
  <div class="login-page">
        ...
        <template #content>
          ...
          <div v-if="authStore.error?.type" class="error-message">
            <div>
              ...
              ></i>
              <span v-if="authStore.error?.type">{{
                authStore.error?.type
              }}</span
              >:
              <span v-if="authStore.error?.status">{{
                authStore.error?.status
              }}</span>
            </div>
    ...
    <div class="login-footer">
      <p>
        &copy; Nexign, JSC, 1992–2025, version: 3.2.0, build time: 2025-03-12
        11:30:11
      </p>
    </div>
  </div>
