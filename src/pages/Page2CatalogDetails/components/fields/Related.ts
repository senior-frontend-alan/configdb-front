...
// Related — для динамических данных из других таблиц, где количество записей может быть очень большим
...
export function formatRelatedValue(value: any, options: FormattingOptions = {}): string {
